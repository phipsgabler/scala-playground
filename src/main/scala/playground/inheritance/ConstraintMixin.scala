...
//    type S
//    type S_Constraint[A]
//    implicit val witness: S_Constraint[S]
//
//    def generate: S
//  }
//
//  trait Mixin1 { self: Base =>
//    type S_Constraint[A] = Class1[A]
//    implicit lazy val witness = implicitly[S_Constraint[S]]
//
//    def generate: S = implicitly[S_Constraint[S]].default1
//  }
//
//  trait Mixin2 { self: Base =>
//    type S_Constraint[A] = Class2[A]
//    implicit lazy val witness = implicitly[S_Constraint[S]]
//
//    def generate: S = implicitly[S_Constraint[S]].default2
//  }
//
//  abstract class Final1 extends  Base {
//    type S = Int
